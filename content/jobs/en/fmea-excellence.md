...
tags: ['AI', 'Machine Learning', 'Python', 'FastAPI', 'Scikit-learn']
blogSlug: digitalleather-backend-engineering
---

- Implemented an algorithm for time-series forecasting that selects the best model for each scenario and uses real-time data.
