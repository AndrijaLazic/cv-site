...
3. **Delegate** — invoke `@coder` for logic/data/API work and `@ui-designer` for component/styling work
4. **Verify** — review agent outputs for consistency and completeness
